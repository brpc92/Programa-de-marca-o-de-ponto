...
<div class="wrapper">
  ...
  <!--      <a href="/admin/starter"> <i class="fa fa-cogs"></i> <span>Controle de Usuarios</span></a>
        ...
        <ul class="treeview-menu">
          <li class="active"><a href="/admin/starter"><i class="fa fa-user"></i> <span>Usuários</span></a></li> 
          </ul>
        </li>
    ...
    <div class="table-responsive">
      <div class="table-responsive box box-primary" > 
            <div class="box-header">
              <a href="/admin/starter/create" class="btn btn-lapin col-md-2 col-xs-4">Novo Usuário</a>
              <form role="form" action="/admin/starter" method="post">
                <button type="submit" style="float:right;" class="btn btn-lapin">
                  <span class="glyphicon glyphicon-search" aria-hidden="true"></span>
                </button>
                <div class="form-group col-md-7 col-xs-6" style="float:right;">
                  <input type="text" style="float:left;" class ="form-control" placeholder="Pesquisa por nome" id="pesquisa" name="pesquisa">
                </div>
              </form>
            </div>
            ...
            <div class="box-body no-padding">
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><?php echo htmlspecialchars( $value1["id_users"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                    ...
                    <td>
                      <a href="/admin/starter/update/<?php echo htmlspecialchars( $value1["id_users"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Editar</a>
                      <a href="/admin/starter/delete/<?php echo htmlspecialchars( $value1["id_users"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" onclick="return confirm('Deseja realmente excluir este registro?')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Excluir</a>
                    </td>
                    <?php } ?>
